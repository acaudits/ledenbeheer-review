...
export type NonConformiteitCardSortering = {
  sleutel: string;
...
type KolomMenuProps = {
  kolom: Kolom;
  filter: string;
  sortering: NonConformiteitCardSortering | undefined;
...
function KolomMenu({
  ...
  return (
    <details
      ...
      data-non-conformiteit-kolommenu="true"
      onToggle={(event) => {
        ...
        document
          .querySelectorAll<HTMLDetailsElement>(
            'details[data-non-conformiteit-kolommenu="true"][open]',
          )
          .forEach((menu) => {
            if (menu !== geopendMenu) {
              menu.open = false;
...
export function NonConformiteitKaartKolombalk({
  kolommen,
  filters,
  sorteringen,
  onFilterWijzigen,
