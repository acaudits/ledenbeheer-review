...
import {
  importeerTerreincontroleStatussen,
  type StatusExcelImportState,
} from "@/app/terreincontroles/status-import-actions";
...
export function TerreincontroleStatusExcelImport() {
      ...
      <div className="flex flex-col gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Upload het resultaatbestand van
            de Kettingzoeker. Kolom A bevat
            het Attest-ID en kolom E de
            nieuwe status.
          </p>
        </div>
