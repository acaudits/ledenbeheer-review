...
export type LaattijdigePlaatsbezoekenCardSortering = {
  sleutel: string;
...
type Props = {
  ...
  sorteringen: LaattijdigePlaatsbezoekenCardSortering[];
...
type KolomMenuProps = {
  kolom: Kolom;
  filter: string;
  sortering: LaattijdigePlaatsbezoekenCardSortering | undefined;
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      ...
      try {
        ...
        if (zoekwaarde.trim() && kolom.sleutel !== "datum") {
...
export function LaattijdigePlaatsbezoekenKaartKolombalk({
  kolommen,
  filters,
  sorteringen,
  onFilterWijzigen,
