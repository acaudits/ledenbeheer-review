...
export function BeheerActieKolomKop() {
  return (
    <th className="sticky right-0 top-0 z-30 w-20 min-w-20 border-b border-slate-200 bg-slate-50 px-3 py-2.5 text-left text-xs font-bold uppercase text-slate-500">
      Acties
    </th>
  );
}
