...
async function leesFoutmelding(
  ...
  return "De ingeplande terreincontroles konden niet worden geladen.";
}

export function useIngeplandeTerreincontrolesQuery({
  ingeschakeld = true,
  zoekterm,
  filters,
  datumJaar,
  ...
  useEffect(() => {
    ...
    window.dispatchEvent(
      new CustomEvent<IngeplandeTerreincontroleServergegevens>(
